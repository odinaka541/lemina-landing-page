        ...
        <div className="space-y-8">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-[rgba(255,255,255,0.02)] border border-[var(--color-border)] rounded-2xl p-6">
                    ...
                    <div className="text-2xl font-bold text-white">$40B+</div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="text-sm">
                            <tr className="border-b border-[rgba(255,255,255,0.05)]">
                                <td className="py-4 text-white font-medium">Flutterwave</td>
                            ...
                            <tr className="border-b border-[rgba(255,255,255,0.05)]">
                                <td className="py-4 text-white font-medium">Interswitch</td>
                            ...
                            <tr className="border-b border-[rgba(255,255,255,0.05)]">
                                <td className="py-4 text-white font-medium">Remita</td>
                                <td className="py-4 text-[var(--color-text-secondary)]">Incumbent</td>
                            ...
                            <tr>
                                <td className="py-4 text-white font-medium">Monnify</td>
