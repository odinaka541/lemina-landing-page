                ...
                <div className="flex-1">
                    {activeTab === 'profile' && (
                        <div className="glass-panel p-8 animate-fade-in">
                            <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-6">Public Profile</h2>
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input type="text" defaultValue="Odinaka" className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium text-[var(--color-text-secondary)]">Last Name</label>
                                        <input type="text" defaultValue="Eze" className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none" />
                                    </div>
                                </div>

                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-[var(--color-text-secondary)]">Bio</label>
                                    <textarea rows={4} defaultValue="Angel investor focused on Fintech and Healthtech in West Africa." className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none resize-none" />
                                </div>

                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-[var(--color-text-secondary)]">Investment Thesis</label>
                                    <textarea rows={3} defaultValue="Backing founders building infrastructure for the digital economy." className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none resize-none" />
                                </div>
                    ...
                    {activeTab === 'notifications' && (
                        <div className="glass-panel p-8 animate-fade-in">
                            <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-6">Notification Preferences</h2>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between py-4 border-b border-[var(--color-border)]">
                                    <div>
                                        <h3 className="font-medium text-[var(--color-text-primary)]">Push Notifications</h3>
                    ...
                    {activeTab === 'security' && (
                        <div className="glass-panel p-8 animate-fade-in">
                            <h2 className="text-xl font-bold text-[var(--color-text-primary)] mb-6">Security Settings</h2>

                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <h3 className="font-medium text-[var(--color-text-primary)]">Change Password</h3>
                                    <div className="grid grid-cols-1 gap-4">
                                        <input type="password" placeholder="Current Password" className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none" />
                                        <input type="password" placeholder="New Password" className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none" />
                                        <input type="password" placeholder="Confirm New Password" className="w-full bg-[var(--input-bg)] border border-[var(--color-border)] rounded-lg px-4 py-2.5 text-[var(--color-text-primary)] focus:border-[var(--color-accent-primary)] outline-none" />
                                    </div>
                                ...
                                <div className="pt-6 border-t border-[var(--color-border)]">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h3 className="font-medium text-[var(--color-text-primary)]">Two-Factor Authentication</h3>
